    ...
    <Menu as="div" className="relative inline-flex">
      {({ open }) => (
        <>
          ...
          <Transition
            as="div"
            className={`origin-top-right z-10 absolute top-full -mr-24 sm:mr-0 min-w-[16rem] xs:min-w-[20rem] bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 py-1.5 rounded-lg shadow-lg overflow-hidden mt-1 ${
            ...
            <MenuItems as="ul" className="focus:outline-none">
              ...
              <MenuItem as="li" className="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
                {({ active }) => (
                  <div className={`block py-2 px-4 ${active && 'bg-gray-50 dark:bg-gray-700/20'}`}>
                    <span className="block text-sm mb-2">
                      🚀 <span className="font-medium text-gray-800 dark:text-gray-100">Predictor Module Update</span>
                    </span>
                    <span className="block text-xs font-medium text-gray-400 dark:text-gray-500">Mar 30, 2025</span>
                  </div>
                )}
              </MenuItem>
            </MenuItems>

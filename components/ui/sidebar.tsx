...
import { Home, Database, Settings, View, BookOpen, Bug } from 'lucide-react'
...
const links: Link[] = [
  ...
  },
  {
    ...
    children: [
      { text: "Overview", href: "/literature/overview", icon: null },
      { text: "Structured Literature Repository", href: "/literature/papers", icon: null },
      { text: "Research Landscape Explorer", href: "/literature/samples", icon: null },
      { text: "Multi-Property Performance Mapper", href: "/literature/properties", icon: null },
      { text: "Materials-Performance Query Engine", href: "/literature/search", icon: null },
    ]
  },
  {
    text: "Autolabel Module",
    href: "/defects",
    icon: <Bug size={16} />,
    children: [
      { text: "Overview", href: "/defects/overview", icon: null },
      { text: "Analysis Dashboard", href: "/defects/analysis", icon: null },
      { text: "Visualization Tools", href: "/defects/visualization", icon: null },
      { text: "Statistical Reports", href: "/defects/statistics", icon: null },
    ]
  },
  {

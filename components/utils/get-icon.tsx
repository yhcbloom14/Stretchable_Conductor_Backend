...
export const getIcon = (type: string): ReactElement => {
    switch (type) {
      ...
      case 'Star':
        return (
          <svg className="w-[16px] h-[16px] text-gray-400 dark:text-gray-500 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
